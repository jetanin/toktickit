...
| `API-11`                                            | API   | AC-09, BR-08     | Requester accessing another user's ticket or attachment                                              | 404 Not Found (or 403 Forbidden); no data leaked                        | `server/tests/lab-03/authorization.api.test.ts`       | Pass  |
...
| `API-19`                                            | API   | AC-12, BR-12     | Reassign ticket to another active IT Staff user                                                      | 200 OK; updates `ticketOwnerId`                                         | `server/tests/lab-03/staff-ticket-detail.api.test.ts` | Pass  |
...
| Acceptance Criterion                                    | Covered By Automated Tests                       | Verification Scope                                  |
| :------------------------------------------------------ | :----------------------------------------------- | :-------------------------------------------------- |
...
| **AC-12** (Claim ticket & reassign owner)               | `API-18`, `API-19`, `UI-05`, `E2E-03`            | Owner assignment & state transition `New` -> `Open` |
